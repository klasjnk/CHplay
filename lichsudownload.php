        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table" >
                    ...
                    <tbody>
                        <?php
                                $ls="SELECT * from lichsudownload where username ='$MSKH'";
                        ...
                        <tr>
                            <?php
                                                    $maapp=$row['msapp'];
                                                    $sql="SELECT * from ungdung where MSAPP='$maapp'";
                                                    $thuchien1=mysqli_query($conn,$sql);
                                                    $app=mysqli_fetch_array($thuchien1);
                                                ?>
                            <td class="price-pr">
                                <p> <?= $app['MSAPP'] ?></p>
                            </td>
                            ...
                            <td><a class="mu-apple-btn"
                                    href="download.php?file=<?php echo $app['file']; ?>&&MSAPP=<?php echo $app['MSAPP']; ?>"><i
                                        class="fa fa-apple"></i><span>Download</span></a></td>
